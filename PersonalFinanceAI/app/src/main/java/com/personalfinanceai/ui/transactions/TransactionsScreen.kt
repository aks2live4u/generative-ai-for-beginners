...
import com.personalfinanceai.ui.components.DonutChart
import com.personalfinanceai.ui.components.DonutSlice
import com.personalfinanceai.ui.components.colorForGroup
import com.personalfinanceai.ui.components.formatRupees
import com.personalfinanceai.ui.components.iconForGroup
import com.personalfinanceai.ui.components.mediumDateFormatter
import com.personalfinanceai.ui.theme.financeColors
...
@Composable
private fun SpendingBreakdownCard(breakdown: List<com.personalfinanceai.ui.dashboard.CategoryBreakdown>) {
    Card(
...
@Composable
private fun SubscriptionDetectorCard(subscriptions: List<com.personalfinanceai.core.model.Subscription>) {
    Card(
        shape = RoundedCornerShape(20.dp),
        colors = CardDefaults.cardColors(containerColor = MaterialTheme.colorScheme.surface),
        modifier = Modifier.fillMaxWidth()
