package com.personalfinanceai.notifications

import android.app.Notification
import android.service.notification.NotificationListenerService
import android.service.notification.StatusBarNotification
import com.personalfinanceai.PersonalFinanceApp
import com.personalfinanceai.core.parser.NotificationTransactionParser
...
class FinanceNotificationListenerService : NotificationListenerService() {
    ...
    override fun onNotificationPosted(sbn: StatusBarNotification) {
        ...
        val app = applicationContext as PersonalFinanceApp
