package com.personalfinanceai.sms
...
import com.personalfinanceai.core.parser.SmsTransactionParser
...
class SmsReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val app = context.applicationContext as PersonalFinanceApp
