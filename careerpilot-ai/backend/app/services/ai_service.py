...
Every agent in app/agents/ calls into this module instead of the OpenAI SDK
directly. That gives us one place to swap providers, and one place where the
"no API key configured" fallback lives -- the app must stay fully usable
...
class AiService:
    def __init__(self) -> None:
        ...
        self._client = OpenAI(api_key=settings.openai_api_key) if self.is_available else None
